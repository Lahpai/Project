                ...
                <div class="row">
                    ...
                    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                            ...
                            <h6>Hi <?php echo $_SESSION['author_name']; ?> |
                        ...
                        <div id="admin-index-form">
                            ...
                            <form method="post">
                                ...
                                Eamil: <input name="author_email" type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email" value="<?php echo $_SESSION['author_email']; ?>"> <br>
                                Password: <input name=" author_password" type="password" class="form-control" id="exampleInputPassword1" placeholder="Password"><br>
                                Your Bio: <textarea name="author_bio" class="form-control" id="exampleFormControlTextarea1" rows="3" value="<?php echo $_SESSION['author_bio']; ?>"></textarea><br>
                                ...
                                if (empty($author_name) or empty($author_email) or empty($author_bio)) {
                                    ...
                                    if (!filter_var($author_email, FILTER_VALIDATE_EMAIL)) {
                                        ...
                                        if (empty($author_password)) {
                                            ...
                                            $sql = "UPDATE `author` SET author_name = '$author_name', author_email= '$author_email',
                                        author_bio='$author_bio' WHERE author_id='$author_id';";
